...
const DebitCategoryWiseReportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Debit Category Wise Report</h1>
        ...
        <div className="mb-8">
          ...
          <EmptyState message="No debit transactions found for this financial year" />
        </div>
      </div>
    </div>
  );
...
export default DebitCategoryWiseReportPage;